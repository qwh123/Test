...
public class SelectPicPop extends PopupWindow {
	...
	public SelectPicPop(Context context, String[] titles, OnClickListener itemsOnClick) {
		super(context);
		...
		takePhotoBtn.setText(titles[0]);
		pickPhotoBtn.setText(titles[1]);
		cancelBtn.setText(titles[2]);
		// 设置按钮监听

...
import com.hp.R;
import com.hp.widget.PickerView;
...
public class TimeSelector {
	...
	public TimeSelector(Context context, ResultHandler resultHandler,
		...
		startCalendar.setTime(TimeSelertorUtils.parse(startDate, FORMAT_STR));
		endCalendar.setTime(TimeSelertorUtils.parse(endDate, FORMAT_STR));
		initDialog();
		initView();
	}
	...
	private void initDialog() {
		if (seletorDialog == null) {
			seletorDialog = new Dialog(context, R.style.dialog);
	...
	private void initView() {
		...
		tv_select.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				handler.handle(TimeSelertorUtils.format(
						selectedCalender.getTime(), FORMAT_STR));
				seletorDialog.dismiss();
			}
		});
	...
	private boolean excuteWorkTime() {
		boolean res = true;
		if (!TextUtils.isEmpty(workStart_str)
				&& !TextUtils.isEmpty(workEnd_str)) {

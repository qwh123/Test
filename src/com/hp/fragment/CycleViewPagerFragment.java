...
import com.hp.widget.BaseViewPager;
import com.hp.widget.CycleViewPagerHandler;

/**
 * 实现可循环，可轮播的viewpager
 */
@SuppressLint("NewApi")
public class CycleViewPagerFragment extends Fragment implements
	...
	private List<UIndex.Data.Banner> infos;
	...
	public void setData(List<ImageView> views, List<UIndex.Data.Banner> list,
	...
	private void setIndicator(int selectedPosition) {
		for (int i = 0; i < indicators.length; i++) {
			indicators[i].setBackgroundResource(R.drawable.banner_dot);
		}
	...
	public static interface ImageCycleViewListener {
		 ...
		 * @param imageView
		 */
		public void onImageClick(UIndex.Data.Banner info, int postion,
				View imageView);
	}
}